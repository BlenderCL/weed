...
class InsertTemplateMenu(bpy.types.Menu):
    bl_idname = "weed.insert_template_menu"
    bl_label = "Insert Template"

    def draw(self, context):
        layout = self.layout
        layout.operator_context = "INVOKE_DEFAULT"
        layout.operator("weed.insert_panel", text = "Panel")
        layout.operator_menu_enum("weed.insert_menu", "menu_type", text = "Menu")
        layout.operator_menu_enum("weed.insert_operator", "operator_type", text = "Operator")
        layout.separator()
        layout.operator("weed.insert_addon_info", "Addon Info")
        layout.operator("weed.insert_register", "Register")
        layout.operator("weed.insert_keymap", "Keymap")
        layout.operator("weed.insert_license", "License")
...
class InsertAddonInfo(bpy.types.Operator, InsertTemplateBase):
    bl_idname = "weed.insert_addon_info"
...
class InsertInvokeFunction(bpy.types.Operator, InsertTemplateBase):
    bl_idname = "weed.insert_invoke_function"
...
class InsertModalFunction(bpy.types.Operator, InsertTemplateBase):
    bl_idname = "weed.insert_modal_function"
...
class InsertDrawFunction(bpy.types.Operator, InsertTemplateBase):
    bl_idname = "weed.insert_draw_function"
...
class InsertRegister(bpy.types.Operator, InsertTemplateBase):
    bl_idname = "weed.insert_register"
...
class InsertOperator(bpy.types.Operator, InsertClassTemplateBase):
    bl_idname = "weed.insert_operator"
