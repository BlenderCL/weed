...
def get_palette(may_use_fancy_formats, theme="classic"):
    ...
    palette_dict = { # {{{ ui
        ...
        "background": (add_setting("white", "bold"), "dark gray"),
        ...
        "command line edit": (add_setting("white", "bold"), "black"),
        "command line prompt": ("white", "black"),

        "command line output": ("light cyan", "black"),
        "command line input": (add_setting("light cyan", "bold"), "black"),
        "command line error": (add_setting("light red", "bold"), "black"),

        "focused command line output": ("black", "dark green"),
        "focused command line input": (add_setting("light cyan", "bold"), "black"),
        "focused command line error": ("black", "black"),
